"""
Django settings for project72th project.
...
SECRET_KEY = 'django-insecure-=#=my-qmzg)lkgb)=^%96+3^(i8x_snrq&7^)4#n))egf&4k!4'
...
WSGI_APPLICATION = 'project72th.wsgi.application'
